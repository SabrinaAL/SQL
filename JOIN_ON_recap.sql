...
-- This time only for the Midwest region. Your final table should include three columns: the region name, the sales rep name, and 
...
JOIN accounts a
ON a.sales_rep_id = s.id
WHERE r.name = 'Midwest' AND rep.name LIKE 'S%'
ORDER BY a.name;
